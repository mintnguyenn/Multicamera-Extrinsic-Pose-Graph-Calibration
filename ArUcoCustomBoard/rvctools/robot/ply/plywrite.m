...
% GAVIN changed on 20110523 the 3rd value along from short to int so it will always write integers and can
% be read in meshlab. My change here is very dodgy but from looking at the alogithm to work out
% the data size to use there is no easy way to change this without large changes.
PlyTypeNames = {'char','uchar','int','ushort','int','uint','float','double', ...
